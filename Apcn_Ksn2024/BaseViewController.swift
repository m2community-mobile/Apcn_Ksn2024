...
let mainColor = #colorLiteral(red: 0.06380447, green: 0.08359161764, blue: 0.2955206037, alpha: 1)

let mainColor2 = #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1)
...
//        subTitleView.backgroundColor = mainColor
        subTitleView.backgroundColor = #colorLiteral(red: 0.25292328, green: 0.2613561451, blue: 0.3672477901, alpha: 1)
