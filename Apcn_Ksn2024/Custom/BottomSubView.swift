...
class BottomSubView: UIView {
    ...
    class PopUpView: UIView {
        ...
        init(delegate kDelegate : BottomSubPopUpViewDelegate, flipView : UIView) {
            ...
            innerView.backgroundColor = #colorLiteral(red: 0.04595427215, green: 0.06341595203, blue: 0.1872401237, alpha: 1)
        ...
        self.bottomSubView?.close{
            DispatchQueue.main.async {
                ...
                case 2:
                    ...
                    break
                case 3:
                    goURL(urlString: URL_KEY.day_3)
                    break
                case 4:
                    goURL(urlString: URL_KEY.day_4)
                    break
                case 5:
                    goURL(urlString: URL_KEY.Program_Introduction)
                    break
                case 6:
                    goURL(urlString: URL_KEY.Official_Social_Program)
                    break
                default:
                    break
                }
