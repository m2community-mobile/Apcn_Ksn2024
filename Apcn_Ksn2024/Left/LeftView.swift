...
class LeftView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        naviBar.backgroundColor = #colorLiteral(red: 0.102912195, green: 0.1479685009, blue: 0.3509129882, alpha: 1)
...
//        settingButton = MainSettingButton(frame: CGRect(x: 0, y: 0, width: naviBar.frame.size.width, height: naviBar.frame.size.height), name: "Setting", imageName: "setting")
        settingButton = MainSettingButton(frame: CGRect(x: 0, y: 0, width: naviBar.frame.size.width, height: naviBar.frame.size.height * 0.6), name: "Setting", imageName: "setting")
        settingButton.backgroundColor = #colorLiteral(red: 0.1510057151, green: 0.2105002701, blue: 0.4571245313, alpha: 1)
        settingButton.frame.origin.x = leftViewContentViewWidth - settingButton.frame.size.width - 15
...
//        naviBar.addSubview(separatorView)
        ...
        let homeButton = ImageButton(frame: CGRect(x: 0, y: 0, width: naviBar.frame.size.height, height: naviBar.frame.size.height), image: UIImage(named: "home"), ratio: 0.35)
...
extension LeftView : UITableViewDelegate, UITableViewDataSource, LeftTableViewHeaderDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if indexPath.row == 0 {
            UserDefaults.standard.setValue(indexPath.row, forKey: "path")
