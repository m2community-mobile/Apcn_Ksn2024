...
//        let noticeView1Text = "Receive the latest information of the KSCCACCC 2023 in real time by clicking on the PUSH notification."
        let noticeView1Text = "Receive the latest information of the APCN 2024 in real time by clicking on the PUSH notification."
...
//                self.navigationController?.popToRootViewController(animated: true)
                ...
                self.navigationController?.viewControllers.insert(MainViewController(), at: 0)
                self.navigationController?.popToRootViewController(animated: true)
