...
//    if let _ = dataDic[INFO.KEY.PhotoListViewControllerTest1] as? String {
//        goPhotoGallery()
//        return
//    }
    
//    if let _ = dataDic[INFO.KEY.IS_PHOTO_GALLERYIndex0] as? String {
//        goPhotoGallery2()
//        return
//    }
//    if let _ = dataDic[INFO.KEY.IS_PHOTO_GALLERYIndex1] as? String {
//        goPhotoGallery3()
//        return
//    }
...
//    let vc = PhotojenicAwardViewController()
...
//func goPhotoGallery2(){
//    
//    
//    let vc = PhotoListViewController0()
//
//    appDel.naviCon?.popToRootViewController(animated: false)
//    appDel.naviCon?.pushViewController(vc, animated: true)
//    appDel.leftView?.close()
...
//func goPhotoGallery3(){
//    
//    
//    let vc = PhotoListViewController1()
//
//    appDel.naviCon?.popToRootViewController(animated: false)
//    appDel.naviCon?.pushViewController(vc, animated: true)
//    appDel.leftView?.close()
