...
extension UIImageView {
    ...
    func setImageWithFrame( image kImage : UIImage?){
        if let image = kImage {
...
extension UIButton {
    ...
    func addGradiant() {
        ...
        let gradientLayer = CAGradientLayer()
        gradientLayer.colors = [UIColor(red: 0.1989385188, green: 0.5700364709, blue: 0.8819643259, alpha: 1).cgColor, UIColor(red: 0.3660022616, green: 0.7538086772, blue: 0.2069598734, alpha: 1).cgColor]
        
        
        #colorLiteral(red: 0.3660022616, green: 0.7538086772, blue: 0.2069598734, alpha: 1)
        ...
        func applyGradient01(colors: [CGColor]) {
...
//               gradientLayer.masksToBounds = false
    ...
    func applyGradient4(colors: [CGColor])
     {
         let gradientLayer = CAGradientLayer()
         gradientLayer.colors = colors
         gradientLayer.startPoint = CGPoint(x: 0, y: 0)
