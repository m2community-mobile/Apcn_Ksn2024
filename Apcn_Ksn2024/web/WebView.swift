...
//    var photogenicAwardNoticeView : PhotogenicAwardNoticeView?
...
//                            print("\(ptX),\(ptY)")
            ...
            print("absoluteString3:\(absoluteString)")
            
//            if absoluteString.contains("vimeo.com"){
...
//            
//            if absoluteString.contains("question.html"){
//                let webVC = WebViewController()
//                  webVC.urlString = urlString
//                  webVC.hideSubTitleView = true
//
//                  appDel.naviCon?.popToRootViewController(animated: false)
////                  appDel.naviCon?.pushViewController(webVC, animated: false)
...
//            }
            ...
            if absoluteString.contains("glance_sub.php") {
                ...
                glanceSubPopUpWC.urlString = newURL + "&deviceid=\(deviceID)"
//                print("------------")
//                glanceSubPopUpWC.urlString = "https://ezv.kr:4447/voting/php/session/glance_sub.php?code=apcn_app&glance=51354&deviceid=\(deviceID)"
//                print("------------")
...
//                    decisionHandler(.cancel); return
//                }
//                if let photogenicAwardNoticeView = self.photogenicAwardNoticeView {
//
//
//
//                    photogenicAwardNoticeView.removeFromSuperview()
//
//                    decisionHandler(.cancel); return
//                }
                //PhotogenicAwardNoticeView
...
//                            toastShow(message: "Mail is not set up.\nPlease set up mail through the Settings app.")
            ...
            if !absoluteString.contains(URL_KEY.BASE_URL) && !absoluteString.contains(URL_KEY.EZV_URL){
                //about:blank
                if absoluteString.contains("https://www.google.com/maps") || absoluteString.contains("about:blank") || absoluteString.contains("https://www.youtube.com") || absoluteString.contains("award.html"){
